...
const no: JodavisitContent = {
  ...
  heroSubtitle:
    'JodaVisit erstatter unødvendige fysiske besøk med videobesøk som oppleves trygge og personlige. Helsepersonell bruker tid der det trengs mest — og den hjemmeboende er aldri alene.',
  heroBadge: 'Hjemmesykepleie og videobesøk',
  primaryCta: 'Kontakt oss',
  scenarioTitle: 'Kjenner du deg igjen?',
  scenarioBody:
    'Hjemmetjenesten har for lite tid og for mange besøk. Mange besøk handler om å sjekke at alt er greit — ikke om å gi pleie. Den hjemmeboende er ensom mellom besøkene. Familien vet ikke hvordan det egentlig går.',
  userGroupsTitle: 'Én løsning for alle',
  userGroups: [
    {
  ...
  features: [
    {
      ...
      description: 'Planlagte og uplanlagte videobesøk. Ingen ekstra programvare for den hjemmeboende.',
    },
    {
      title: 'Hub-skjerm hjemme',
      description: 'Kjøres på nettbrett eller TV. Familien er alltid nær via bilder, meldinger og video.',
    },
    {
      title: 'Kalender og påminnelser',
      description: 'Automatiske påminnelser til den hjemmeboende før planlagte besøk.',
    },
    {
      title: 'Dokumentasjon etter besøk',
      description: 'Helsepersonell dokumenterer direkte i JodaCare etter videobesøket.',
    },
  ],
  statusBadge: 'Kommer',
  statusTitle: 'Under utvikling',
  statusBody: 'JodaVisit er under utvikling som del av JodaCare 2.0. Ta kontakt for å melde interesse.',
...
const en: JodavisitContent = {
  ...
  heroSubtitle:
    'JodaVisit replaces unnecessary physical visits with video visits that feel safe and personal. Staff spend time where it matters most — and the person at home is never alone.',
  heroBadge: 'Home nursing and video visits',
  primaryCta: 'Contact us',
  scenarioTitle: 'Does this sound familiar?',
  scenarioBody:
    'Home care has too little time and too many visits. Many visits are about checking that everything is fine — not about hands-on care. The person at home is lonely between visits. The family does not really know how things are going.',
  userGroupsTitle: 'One solution for everyone',
  userGroups: [
    {
    ...
    },
    {
      ...
      description:
        'The family room gives insight into everyday life. Video call in one tap. Always updated — without calling home care for every question.',
    },
  ],
